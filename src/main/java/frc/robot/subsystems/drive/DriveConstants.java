...
public class DriveConstants {
  public static final double maxSpeedMetersPerSec = 22.1;
  ...
  // Device CAN IDs
  public static final int pigeonCanId = 49; //Make Rev PDH 50
  ...
  public static final double driveMotorReduction = (5.36); // MK4i L3+
  ...
  public static final double turnMotorReduction = 150.0 / 7.0; // MK4i Swerve
